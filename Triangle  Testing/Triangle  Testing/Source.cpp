...
int main()
{
	...
	do{
		...
		else if (userInputTriangleType == "Equilateral" || userInputTriangleType == "equilateral")
		{
			equilateralTriangle();
			std::cout << "Would you like to calculate another Triangle? \n Yes  or  No \n >";
			std::cin >> finish;
...
void isoscelesTriangle()
{
	...
	if (userInputSide == "C" || userInputSide == "c")
	{
		...
		sideC = sqrt(((sideB/2) * (sideB/2)) + (sideA * sideA));
		area = (sideA * sideB) / 2;
	...
	else if (userInputSide == "B" || userInputSide == "b")
	{
		...
		sideB = (sqrt((sideC * sideC) - (sideA * sideA)))*2;
		area = (sideA * sideB) / 2;
		perimeter = 2 * sideA + sideB;
		std::cout << "The distance for side B is " << sideB << "\nThe area of the triangle is " << area << "\nThe perimeter of the triangle is " << perimeter << std::endl;
	}
	else if (userInputSide == "A" || userInputSide == "a")
	{
		...
		sideA = sqrt(((sideB / 2) * (sideB / 2)) - (sideC * sideC));
		area = (sideA * sideB) / 2;
		perimeter = 2 * sideA + sideB;
		std::cout << "The distance for side A is " << sideA << "\nThe area of the triangle is " << area << "\nThe perimeter of the triangle is " << perimeter << std::endl;
	}
...
void equilateralTriangle()
{
	...
	if (userInputSide == "C" || userInputSide == "c")
	{
		std::cout << "You chose side " << userInputSide << ", what is the distance for side A or B. \n >";
		std::cin >> sideA;
		...
		perimeter = sideA + sideB + sideC;
		std::cout << "The distance for side C, B, and A is " << sideC << "\nThe area of the triangle is " << area << "\nThe perimeter of the triangle is " << perimeter << std::endl;
	}
	if (userInputSide == "B" || userInputSide == "b")
	{
		std::cout << "You chose side " << userInputSide << ", what is the distance for side A or C. \n >";
		std::cin >> sideA;
		...
		area = (sqrt(3) / 4) * (sideA * sideA);
		perimeter = sideA + sideB + sideC;
		std::cout << "The distance for side B, C, and A is " << sideB << "\nThe area of the triangle is " << area << "\nThe perimeter of the triangle is " << perimeter << std::endl;
	}
	if (userInputSide == "A" || userInputSide == "a")
	{
		std::cout << "You chose side " << userInputSide << ", what is the distance for side B or C. \n >";
		std::cin >> sideB;
